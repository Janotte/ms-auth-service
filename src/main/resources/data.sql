...
INSERT INTO tb_users(user_id, username, full_name, email, password, cell_phone_number, image_url, created_at, updated_at) VALUES
(UUID_TO_BIN('38b8f33c-19f8-11ee-a34f-8cb0e92fd151'), 'Administrator', 'System Administrator', 'admin@supptech.net.br', '12345678', '(0xx47) 99999-9999', '\images\v', NOW(), NOW()),
(UUID_TO_BIN('38b9035c-19f8-11ee-a34f-8cb0e92fd151'), 'Client01', 'Client 01', 'client01@supptech.net.br', '12345678', '(0xx47) 99999-0001', '\images\01', NOW(), NOW()),
(UUID_TO_BIN('38b904a2-19f8-11ee-a34f-8cb0e92fd151'), 'Client02', 'Client 02', 'client02@supptech.net.br', '12345678', '(0xx47) 99999-0002', '\images\02', NOW(), NOW()),
(UUID_TO_BIN('38b90534-19f8-11ee-a34f-8cb0e92fd151'), 'Client03', 'Client 03', 'client03@supptech.net.br', '12345678', '(0xx47) 99999-0003', '\images\03', NOW(), NOW()),
(UUID_TO_BIN('38b905bf-19f8-11ee-a34f-8cb0e92fd151'), 'Client04', 'Client 04', 'client04@supptech.net.br', '12345678', '(0xx47) 99999-0004', '\images\04', NOW(), NOW()),
(UUID_TO_BIN('38b90641-19f8-11ee-a34f-8cb0e92fd151'), 'Client05', 'Client 05', 'client05@supptech.net.br', '12345678', '(0xx47) 99999-0005', '\images\05', NOW(), NOW());
